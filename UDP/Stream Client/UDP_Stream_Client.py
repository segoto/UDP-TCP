# -*- coding: utf-8 -*-
"""
Created on Tue Apr  7 16:02:33 2020
...
def checkArg():
    """this works omly if executed from command prompt window"""
    if len(sys.argv) != 2:
        print(
            "ERROR. Wrong number of arguments passed. System will exit. Next time please supply 1 argument!")
        sys.exit()
    else:
        print("1 Arguments exist. We can proceed further")
...
while True:
    ...
    if CL[0] == "get":
        ...
        print("Server will exit if you have entered port number correctly, but you will not receive Server's message here.")
        sys.exit()
